...
ggplot(data = df, aes(x = trend, y = vals, group = apps)) +
  ...
  labs(x = "Months (March 2020=0)", y = "Number of active users",
       caption = "Note: The dotted horizontal lines indicate when the first, second and third waves started and the red dashed line denotes the linear trend calculated on the data before March 2020") -> p1
p1
```
